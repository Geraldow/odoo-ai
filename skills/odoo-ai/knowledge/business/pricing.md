---
title: Pricing & Pricelist Patterns
domain: business
version: all
edition: both
source: fhidalgo+peterurban
status: active
---

# Pricing & Pricelist Patterns

## Purpose
product.pricelist, quantity breaks, multi-currency, discount.
...
customer_pricelist = self.env['product.pricelist'].create({
    ...
    'item_ids': [
        (0, 0, {
            'applied_on': '3_global',
            'compute_price': 'percentage',
            'percent_price': partner.x_special_discount or 0,
        }),
    ],
})
